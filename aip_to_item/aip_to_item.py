...
parser = argparse.ArgumentParser(description='Create a DSpace Item from an Archivematica AIP. Update the ArchivesSpace Digital Object.')
parser.add_argument(
    'function', choices = ['file', 'dir']
)
args = parser.parse_args()

if args.function == 'dir':
